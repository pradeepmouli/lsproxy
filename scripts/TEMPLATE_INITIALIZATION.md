...
**Purpose**: Analyze project context and recommend relevant skills from https://skills.sh/

**Usage**:
```bash
scripts/discover-skills.sh "project-name" "project description" [project-type]
```

**Example**:
```bash
scripts/discover-skills.sh "my-api" "REST API for user management" "backend"
```
